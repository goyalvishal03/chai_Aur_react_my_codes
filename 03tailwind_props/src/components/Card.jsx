...
function Card({ channelName = "unknown" }) {
  // console.log("props",props);
  return (
    <div className="flex p-6 font-mono">
      <div class="  before:w-full before:h-full  flex-none w-48 mb-10 relative z-10 before:absolute before:top-1 before:left-1 before:bg-teal-400">
        <img
          src="/retro-shoe.jpg"
          alt=""
